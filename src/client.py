...
class MeyersAPIClient:
    ...
    def __init__(self, school_id: str = SCHOOL_ID, language: str = DEFAULT_LANGUAGE, target_offer_id: str = TARGET_OFFER_ID):
    ...
    def fetch_data(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.post(self.base_url, json=payload, headers=self.headers, timeout=REQUEST_TIMEOUT)
