...
class TestMCPServer(unittest.TestCase):
    ...
    def test_health_check(self, mock_processor, mock_client):
        ...
        self.assertIsNotNone(health_check_tool, "health_check tool should be registered")
    ...
    def test_get_available_dates(self, mock_processor, mock_client):
        ...
        self.assertIsNotNone(get_dates_tool, "get_available_dates tool should be registered")
    ...
    def test_get_menu_by_date_invalid_format(self, mock_processor, mock_client):
        ...
        self.assertIsNotNone(get_menu_tool, "get_menu_by_date tool should be registered")
    ...
    def test_tool_registration(self):
        ...
        for tool_name in expected_tools:
            self.assertIn(tool_name, registered_tools, f"Tool {tool_name} should be registered")
    ...
    def test_tool_parameters(self):
        ...
        self.assertEqual(len(get_all_menus_tool.parameters), 3)  # school_id, language, target_offer_id
        ...
        self.assertEqual(len(get_menu_tool.parameters), 4)  # date, school_id, language, target_offer_id
